...
public static class CurrencyHelper
{
    ...
    private static readonly Dictionary<string, string> CurrencyToImageLink = new()
    {
        ...
        {
            "ex shard",
            "https://web.poecdn.com/gen/image/WzI1LDE0LHsiZiI6IjJESXRlbXMvQ3VycmVuY3kvRXhhbHRlZFNoYXJkIiwic2NhbGUiOjF9XQ/b9e4013af5/ExaltedShard.png"
        },
    };

    private const string DefaultImage = "https://web.poecdn.com/protected/image/trade/layout/logo.png?key=aifr8Q9qj0FYhhu8_rrfhw";
    ...
    {
        if (CurrencyToImageLink.TryGetValue(currencyName, out var value)) return value;

        var norm = GetNormalizedName(currencyName);
        return CurrencyToImageLink.GetValueOrDefault(norm, DefaultImage);
    }
